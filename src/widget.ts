...
const ICON_QR =
  '<svg viewBox="0 0 20 20" width="16" height="16" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linejoin="round"><rect x="3" y="3" width="5.5" height="5.5" rx="1.2"/><rect x="11.5" y="3" width="5.5" height="5.5" rx="1.2"/><rect x="3" y="11.5" width="5.5" height="5.5" rx="1.2"/><rect x="11.5" y="11.5" width="2.4" height="2.4" rx=".6" fill="currentColor" stroke="none"/><rect x="14.6" y="14.6" width="2.4" height="2.4" rx=".6" fill="currentColor" stroke="none"/></svg>'
const ICON_KAKAOPAY =
